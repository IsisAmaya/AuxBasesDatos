...
Cantidad INT,
    ...
    FOREIGN KEY (Id_producto) REFERENCES PRODUCTO (Id_producto) 
	ON UPDATE RESTRICT ON DELETE CASCADE,
    CONSTRAINT Id_carrito PRIMARY KEY (Id_cliente,Id_producto)
);

INSERT INTO CLIENTE (Id_cliente, Nombre, Email, Contraseña, Telefono, Ciudad) VALUES (1, 'Esteban', 'esteban1@gmail.com', 'contranueva', 39854350, 'Manizales');
INSERT INTO CLIENTE (Id_cliente, Nombre, Email, Contraseña, Telefono, Ciudad) VALUES (2, 'Majo', 'majos2@gmail.com', 'lobito', 37294639, 'Bucaramanga');
INSERT INTO CLIENTE (Id_cliente, Nombre, Email, Contraseña, Telefono, Ciudad) VALUES (3, 'Natalia', 'nati3@gmail.com', 'mariposa', 35894858, 'Bogota');
INSERT INTO CLIENTE (Id_cliente, Nombre, Email, Contraseña, Telefono, Ciudad) VALUES (4, 'Sebastian', 'sebas4@gmail.com', 'ositocariñosito', 38954519, 'Ibague');
INSERT INTO CLIENTE (Id_cliente, Nombre, Email, Contraseña, Telefono, Ciudad) VALUES (5, 'Antonio', 'antonito5@gmail.com', 'tortugaveloz', 34983238, 'Cali');
INSERT INTO CLIENTE (Id_cliente, Nombre, Email, Contraseña, Telefono, Ciudad) VALUES (6, 'Maria', 'mariaAntionet6@gmail.com', 'libelula', 30945123, 'Pasto');
INSERT INTO CLIENTE (Id_cliente, Nombre, Email, Contraseña, Telefono, Ciudad) VALUES (7, 'Jose', 'joselito7@gmail.com', 'aguilaciega', 31205084, 'Bucaramanga');
INSERT INTO CLIENTE (Id_cliente, Nombre, Email, Contraseña, Telefono, Ciudad) VALUES (9, 'Laura', 'LauSp@gmail.com', 'mariquita', 38487501, 'Bogota');
INSERT INTO CLIENTE (Id_cliente, Nombre, Email, Contraseña, Telefono, Ciudad) VALUES (10, 'Isis', 'ikatitza12@gmail.com', 'gatooo', 35047463, 'Medellin');
...
INSERT INTO PRODUCTO(Id_producto,Id_categoria,SKU,Nombre,Precio,Descripcion,Stock) VALUES (128653,103,'PQH13645','Pan lavash',5000,'En Armenia y otros países del Caúcaso es muy común encontrar el pan lavash, un pan de origen persa muy similar al blanco tradicional.',15);
